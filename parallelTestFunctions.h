...
namespace parallel {
	...
	//========== EDENSCH ===========
	double EDENSCHvalgradRandged(double*g, double*x, INT begin, INT end)
	{
	...
	{
		double fx = valgradParallel(EDENSCHvalgradRandged, g, x, n);
		double item1, item2, item3;
	...
	void EDENSCHgradRandged(double*g, double*x, INT begin, INT end)
	{
		INT i;
		for (i = begin; i < end; i++)
			g[i] = 0;
	...
	{
		gradParallel(EDENSCHgradRandged, g, x, n);
		double item1, item2, item3;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = x[i] - 2;
	...
	//========== ENGVAL1 ===========
	double ENGVAL1valgradRandged(double*g, double*x, INT begin, INT end)
	{
		double item;
		for (int i = begin; i < end; ++i)
			g[i] = 0;
	...
	{
		double fx = valgradParallel(ENGVAL1valgradRandged, g, x, n);
		double item;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item = pow(x[i], 2.0) + pow(x[i + 1], 2.0);
	...
	void ENGVAL1gradRandged(double*g, double*x, INT begin, INT end)
	{
		INT i;
		for (i = begin; i < end; i++)
			g[i] = 0.0;
	...
	{
		gradParallel(ENGVAL1gradRandged, g, x, n);
		double item;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item = pow(x[i], 2.0) + pow(x[i + 1], 2.0);
	...
	//========== FREUROTH ===========
	double FREUROTHvalgradRandged(double*g, double*x, INT begin, INT end)
	{
		double item1, item2;
		for (int i = begin; i < end; ++i)
			g[i] = 0;
	...
	{
		double fx = valgradParallel(FREUROTHvalgradRandged, g, x, n);
		double item1, item2;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = (-13 + x[i] + ((5 - x[i + 1])*x[i + 1] - 2.0)*x[i + 1]);
	...
	void FREUROTHgradRandged(double*g, double*x, INT begin, INT end)
	{
		INT i;
		for (i = begin; i < end; i++)
			g[i] = 0.0;
	...
	{
		gradParallel(FREUROTHgradRandged, g, x, n);
		double item1, item2;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = (-13 + x[i] + ((5 - x[i + 1])*x[i + 1] - 2.0)*x[i + 1]);
	...
	//========== GENHUMPS ===========
	double GENHUMPSvalgradRandged(double*g, double*x, INT begin, INT end)
	{
		double item1, item2;
		for (int i = begin; i < end; ++i)
			g[i] = 0;
	...
	{
		double fx = valgradParallel(GENHUMPSvalgradRandged, g, x, n);
		double item1, item2;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = sin(2.0*x[i]);
	...
	void GENHUMPSgradRandged(double*g, double*x, INT begin, INT end)
	{
		INT i;
		for (i = begin; i < end; i++)
			g[i] = 0.0;
	...
	{
		gradParallel(GENHUMPSgradRandged, g, x, n);
		double item1, item2;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = sin(2.0*x[i]);
